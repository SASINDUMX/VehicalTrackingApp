...
-- 10. STAGE TIMER START / STOP (PAUSE / RESUME) SUPPORT
...
ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS paused_seconds INT NOT NULL DEFAULT 0;

ALTER TABLE stage_logs ADD COLUMN IF NOT EXISTS is_paused BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE stage_logs ADD COLUMN IF NOT EXISTS paused_at TIMESTAMPTZ;
ALTER TABLE stage_logs ADD COLUMN IF NOT EXISTS paused_seconds INT NOT NULL DEFAULT 0;
